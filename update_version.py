...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright JanKowal, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Caramel-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Caramel-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Caramel-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Caramel-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Caramel-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Caramel-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Caramel-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Caramel.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Caramel.iss",inplace=1):
